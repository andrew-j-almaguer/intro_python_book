...
# remainders_5 is similar to remainders_3 in the previous exercise in that it
# returns a list of integers. In this list, a value of 0 means the
# corresponding number is divisible by 5, while a non-zero value means the
# number is not divisible by 5. Since 0 is falsy and the other integers are
# truthy, we can use all to determine whether all of the numbers are not
# divisible by 5.